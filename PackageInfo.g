#############################################################################
##  
##  PackageInfo.g for the package `gap-graphs'                   JanoÅ¡ Vidali
##  

SetPackageInfo( rec(

##  This is case sensitive, use your preferred spelling.
PackageName := "gap-graphs",
...
##  
README_URL := "https://github.com/jaanos/gap-graphs/blob/master/README.md",
PackageInfoURL := "https://github.com/jaanos/gap-graphs/blob/master/PackageInfo.g",
...
##  
AbstractHTML := "<span class=\"pkgname\">gap-graphs</span> is a package with \
various constructions of graphs, mostly distance-regular graphs.",

PackageWWWHome := "https://github.com/jaanos/gap-graphs",
...
PackageDoc := rec(
  ...
  LongTitle := "Graph constructions in GAP",
...
Subtitle := "Graph constructions in GAP",
...
Keywords := ["graph","distance-regular","strongly-regular"]
